...
function MapViewer(props){
    ...
    return(
        <div className="max-w-xl h-96 max-h-xl">
            <MapContainer center={[props.markers[0]['lat'], props.markers[0]['lng']]} zoom={3} scrollWheelZoom={true}>
                <TileLayer
                ...
                {props.markers.map((marker,_) =>{
                    return(
                        <Marker position={[marker['lat'], marker['lng']]} icon={LeafIcon} eventHandlers={{
                            click: () => {
